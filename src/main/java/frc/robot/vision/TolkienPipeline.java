...
/**
* TolkienPipeline class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class TolkienPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdSaturation = {66.0, 240.0};
		double[] hsvThresholdValue = {123.0, 255.0};
		...
		double[] filterContoursSolidity = {0, 60.0};
